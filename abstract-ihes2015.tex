...
\begin{abstract}
  In algebraic geometry, one often studies schemes from a local or relative
  point of view. We describe how the internal language of certain
  ...
  The starting point is that sheaves of rings and sheaves of modules look
  just like plain rings respectively modules from the internal point of view.
  ...
  A particularly interesting task is to internalize the ``relative spectrum''
  construction of algebraic geometry, which given a quasicoherent sheaf of algebras
  on a scheme~$X$ yields a scheme over~$X$. From the internal point of
  view, this construction should simply reduce to a intuitionistically sensible
