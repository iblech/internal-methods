...
\renewcommand{\vfill}{\ }
\renewcommand{\vfil}{\ }
{\centering\includegraphics[width=0.3\textwidth]{phantoms}\par}
\maketitle
}
...
Exercises: negneg proof, stability of the HA axioms, applications of Barr
negneg drinker and CPS perspective
