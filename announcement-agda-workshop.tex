...
\begin{frame}[plain]
  ...
  \includegraphics[width=0.8\textwidth]{agda-course/wendelstein-1}

  \includegraphics[height=0.245\textwidth]{agda-course/wendelstein-2}
  \includegraphics[height=0.245\textwidth]{agda-course/wendelstein-3}
\end{frame}
