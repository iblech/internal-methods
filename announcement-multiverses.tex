...
\newenvironment{transbox}{%
  \begin{tikzpicture}
     \node[fill=black, fill opacity=0.6,text opacity=1]
...
\begin{frame}[c,plain]
  ...
  \hil{Das mathematische Multiversum} \\[-0.9em]
  \
  \end{block}

  \emph{-- Semesterauftaktvortrag --}
  ...
  \begin{minipage}{1.0\textwidth}
    \begin{transbox}\color{white} \bignumber{1} Die Grundaxiome der Mathematik\end{transbox}
    \bigskip

    \qquad\begin{transbox}\color{white} \bignumber{2} Wahre Aussagen, die unbeweisbar sind\end{transbox}
    \bigskip

    \qquad\qquad\begin{transbox}\color{white} \bignumber{3} Zahlen, die so groß sind, dass sie die Mathematik brechen\end{transbox}
    \bigskip

    \qquad\qquad\qquad\begin{transbox}\color{white} \bignumber{4} Mathematische Universen und wie man sie bereist\end{transbox}
  \end{minipage}
