...
\begin{prop}Let~$X$ be a scheme. Let~$\I \subseteq \O_X$ be a radical ideal.
\begin{enumerate}
...
\begin{align*}
  \I_0 &\defeq \I, \\
  \I_{n+q} &\defeq \textnormal{the radical ideal generated by
...
\begin{rem}A purely formal description of the reflector is given by
\[ \I \longmapsto \bigcap \{ \J \subseteq \A \,|\,
  \text{$\J$ is a quasicoherent radical ideal such that~$\I \subseteq \J$} \}. \]
\end{rem}

\begin{rem}If in the situation of the proposition the algebra~$\A$ is not
