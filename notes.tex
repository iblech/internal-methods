...
proposition~\ref{prop:module-zero-point-neighbourhood}.)
...
Vries~\cite{vries:sheafification}\footnote{Note that on page~5 of this
...
\begin{prop}\label{prop:module-zero-point-neighbourhood}
Let~$X$ be a scheme (or ringed space). Let~$\F$ be an~$\O_X$-module
of finite type.
\begin{itemize}
...
\item reduced closed subscheme; $j_!$; $j_! \O_U$ flat over~$\O_X$, \ldots
