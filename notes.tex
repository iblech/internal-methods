...
above, an open subset~$U \subseteq X$ defines an internal truth value also
...
\begin{prop}Let~$U \subseteq X$ be a fixed open and~$A \subseteq X$ be a fixed
...
\end{prop}
Here,~``$X_\Box$'' denotes the sublocale of~$X$ defined by~$\Box$; we will
