...
and we deduce, as a an application, a description of limits in the category of
...
sheaf~$\O_{\Spec(A)} \defeq \ul{A}[\F^{-1}]$ (as described in
Section~\ref{sect:generic-filter}.\end{defn}
