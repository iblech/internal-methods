...
in general,\footnote{Assume that the universal localization of a ring~$A$ exists. Then any
...
\begin{proof}To demonstrate the technique we verify the second and the last claim.
...
A basic illustration of these modal operatos is provided by the Kummer sequence, that is the short sequence
...
Here, a ring is \emph{separably closed}~$A$ if and only if
\begin{multline*}
