...
one is of independent constructive interest and such that the structure sheaf
...
The second one is quite weak, but still useful enough to derive nontrivial
consequences. It is satisfied by the structure sheaf of any (not necessarily
locally Noetherian) reduced scheme.
...
and suffices for the applications of the Noetherian condition one has in mind.
...
given in~\cite[page XXX]{atiyah:macdonald:commutative-algebra}, shows that
...
intuitionistic proof of the following statement: Let~$k$ be a ring such that
