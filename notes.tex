...
holds in the sheaf toposes~$\Sh(U_i)$, it holds in~$\Sh(X)$ as well. So, for
instance, global properties of sheaves of modules like ``generated by global
...
% XXX: global generation; simultaneous vanishing
