...
But except for trivial cases, the map~$\GG_\text{m}
\stackrel{(\underline{\ })^n}{\lra} \GG_\text{m}$ will fail to be an epimorphism;
...
\emph{is} true.
% Can we characterize \Box_ét internally? Check Wraith!
