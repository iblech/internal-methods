...
on the ambient logical framework), we need \emph{dependent types}.
\XXX{describe those}
...
fact that on Dedekind schemes, torsionfree~$\O_X$-modules are locally free.
...
of~$X$; this is obviously a genuine locale-theoretic notion, since a topological
