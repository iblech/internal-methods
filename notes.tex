...
D(b)$. Therefore~$U \models \Box V$ implies~$U \models \Box(\speak{$b$ \inv})$. By
...
% This doesn't seem to be obvious. The statement is that K_X is a sheaf for (U => __).
% It certainly is separated with respect to this modal operator, but I don't
% see how to prove that it is a sheaf.
