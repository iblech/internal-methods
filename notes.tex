...
\XXX{cite http://arxiv.org/abs/1404.4549}

\XXX{mention Jackson's thesis}
...
of rational functions (proposition~XXX).
...
are easy to describe: There are precisely the sheaves in the essential image of
...
in other contexts
before~\cite{aczel:russel-prawitz,escardo:oliva:peirce-shift}. To the best of
...
topos, without holding in any topos, \ie possessing an intuitionistic proof. We
