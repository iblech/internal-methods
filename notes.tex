...
\subsection[The relative spectrum as an ordinary spectrum]{The relative
spectrum as an ordinary spectrum from the internal
...
spectrum~$\RelSpek_X \O_X[f^{-1}]$. Inclusions of more general open subsets
