...
sense that nonzero elements are invertible. This is without any assumptions on
...
* D(f)
* V(f). Note that not equal to V(f^2), even though field.
* A^1.
* modal operator corresponding to étale topology, ...
