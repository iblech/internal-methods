...
theory~\cite{bauer:synthetic-computability-theory}, and more recently homotopy
...
% XXX: move to after modules have been discussed
...
% XXX: Reformulate a little bit. Third version should be mentioned only later.
...
Explain the following motto: When unstructured sets don't have the flavour of
the desired objects of study, there are two options: Equip them with structure
(locally ringed spaces or homotopy types) or switch to an alternate topos.
This is done in homotopy type theory. And it also works well with the big
Zariski topos.
