...
number~$a$ is actually a continuous function~$a : X \to \RR$, that is, a continuous
family of real numbers on~$X$.
...
\begin{figure}
  ...
  no open neighborhood~$V$ of the unique zero of the depicted function~$a$ has
  the property that~$a$ is everywhere negative, everywhere zero or everywhere
  positive on~$V$.}
\end{figure}
