...
the implementation of~$X$ nor on its specific choice of rational
...
original notion of toposes. Categorically, the step from topological spaces
...
\begin{figure}
  ...
  \marginnote{
    \begin{ocg}[printocg=never]{layername}{layerid1}{on}
      ...
      In the online version of this book, a video of the
      continuous family is shown here.\end{minipage}
    \end{ocg}
  }
...
\]
We write~$\langle a,b \rangle$ more suggestively
as~$a+b\varepsilon$.
