...
as well for the realizability topos
constructed using infinite time Turing
machines~\cite{bauer:injection,hamkins-lewis:ittm} and indeed for any realizability
topos, with the same proof, as power objects are always
...
XXX: injective as module implies functionally flabby

Cite! https://arxiv.org/pdf/2008.10677.pdf
