...
Although we will see in XXX and in Section~\ref{sect:in-eff} that there is some
...
\item Any set embeds canonically (in a uniform fashion) into an injective set.
...
axiom of choice), any module embeds into an
injective module.
...
Any set canonically embeds into a flabby set.\end{cor}
...
\begin{prop}Any singleton set is flabby. The binary cartesian product of flabby sets
is flabby.\end{prop}
...
\begin{enumerate}
\item Any object embeds canonically into an internally injective object.
...
\item Any object embeds canonically into a flabby object.
\item Any internal module embeds canonically into an internal module which is flabby.
...
coincides with~$\Sh(Y)$ [XXX give reference]; in particular, a given sheaf~$E$ of~$\O_Y$-modules can
...
their stead. There are, however, two problems with this
...
following Scholium~\ref{scholium:exact-as-presheaves}. XXX
...
XXX cite more references for Eff, including
Hyland §5
Fourman-Scott 1979
Johnstone 1977
toposmoeder
