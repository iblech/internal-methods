...
cohomology from the internal point view.
...
to give a new proof of Roswitha Harting's result that injectivity of sheaves is
...
small mistake of her, namely claiming that no generalization to sheaves of
modules would be possible.

When employing the internal language, we are always referring to Mike Shulman's
extension of the usual language, his \emph{stack
...
choice~\cite{blass:inj-proj-axc}, but it is also known that flabby resolutions
can be used in their stead, making them the obvious candidate for a
...
goal. To the best of our knowledge, the problem of giving a constructive accout
of sheaf cohomology is still open.

In view of almost 80 years of sheaf cohomology, this state of affairs is
slightly embarassing, challenging the call that ``once [a] subject is better
understood, we can hope to refine its definitions and proofs so as to
avoid that axiom''~\cite[Section~3.4]{hott}.
...
in the internal setting of toposes, thereby extending the applicability of
...
and to Jürgen Jost, Marc Nieper-Wißkirchen and Peter Schuster for valuable
guidance. Most of the work for this note was carried out at the University of
...
but might fail to be flabby. % XXX because sheaf cohomology is often nontrivial
% and because of the Brouwerian counterexample
\end{rem}
...
point not as well-developed as it is today, she had to go to considerable
