...
Theorem~\ref{thm:higher-direct-images-as-internal-sheaf-cohomology} that in our
case, it does, and that the resulting sheaf coincides with the~$n$-th higher
direct image of~$E$.
...
simple application, a geometric explanation that higher direct images along
