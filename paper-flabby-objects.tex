...
We follow the terminology of~\cite{hyland:effective-topos}(XXX). The intuitive
reason for why Proposition~\ref{prop:flabby-effective-sets} holds is the
following. Let~$X$ be a flabby object of the effective topos. Then there is a
...
on~$K$, but this fine point is not important for the further discussion. Let
...
Reflexivity realizers for these objects may not be very informative themselves;
...
flabby modules, assuming the law of excluded middle, while
