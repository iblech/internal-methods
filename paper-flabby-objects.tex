...
base, exploting that any non-global element becomes a global element after a suitable
change of base.
\end{proof}
...
arbitary choices to yield a globally-defined sheaf over~$X$ -- following the
...
Let~$Y$ be a ringed locale over a locale~$X$. Let~$I$ be a sheaf of modules over~$Y$.
...
on~$K$, but this fine point is not important for this discussion. Let~$f : X \to X$
