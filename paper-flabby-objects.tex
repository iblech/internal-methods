...
= 0 + t$, $0t = 0$, $1t = t$, $r(t+u) = rt + ru$, $(r+r')t = rt + r't$; if~$x,y
...
Every group satisfying the Baer condition is divisible, by specializing~$\aaa$
to the ideal~$(n)$ and using multiplication by~$x$ as the map~$\aaa \to I$.
...
underlying abelian group of the free~$\QQ$-vector space on the underlying set of~$A$ and~$K$ is the
...
CITE:
https://stacks.math.columbia.edu/tag/05NM
Oberst relative satellites
Amitsur derived functors
Buchsbaum satellites
Buchsbaum a note on homology
Stauffer derived functors without injectives
Felix
Thierry
Huber Calculation of derived functors
Huishan WU, Revers mathematics and semisimple rings

https://www.math.uni-duesseldorf.de/~schroeer/publications_pdf/FlasqueSheaves.pdf
and reference 17 there

Remark that our flabby hulls are not qcoh in general

Bell, J. L. (1997). Zorn’s lemma and complete Boolean algebras in
intuitionistic type theories. The Journal of Symbolic Logic, 62(04),
1265–1279.

Grothendieck's letter to Larry Breen in 1975: doing without injective
resolutions

https://arxiv.org/abs/1903.01211

Cite:
https://arxiv.org/abs/1802.00960

https://ncatlab.org/nlab/show/algebraically+injective+object

https://www.cse.chalmers.se/~coquand/course231.pdf#page=23
Perhaps flabby objects could be called "contractible objects"?

cite
https://arxiv.org/pdf/1903.01211
Thm. 19, 20
for discussion of "functionally flabby ↔ injective"

Cite general idea or injectivity aspects of:
https://1lab.dev/Data.Partial.Properties.html

Cite Montaruli https://arxiv.org/pdf/2203.12490, Cor. 2.17:
"divisible ⇒ injective" implies WLEM.
