...
freeness lemma. We include it here because we want to present its proof, which
is easier and shorter than the proof of the general case. The general proof
will be self-contained and not refer to this one.
