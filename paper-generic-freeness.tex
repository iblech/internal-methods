...
% XXX: Check formulation of the topos case. Is it true that the join of open
% subtoposes is open?
...
TODO:
look into Perdry, Journal of Symbolic Computation for a pointer to the
Gordan--Dickson lemma. This might be cited.

TODO:
Cite Martin Brandenburg?
