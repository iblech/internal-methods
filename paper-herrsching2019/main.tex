...
% Ex.: Z finitely generated

This definition is at odds with the idea that constructive mathematics should
be informative, because it only expresses that it is impossible for no finite
...
However, it is still useful in constructive algebra when interpreted by the
sheaf semantics: If~$A$ is reduced, then~$A^\sim$ is anonymously Noetherian.
XXX
