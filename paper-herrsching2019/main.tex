...
the meet-irreducible open subsets.
...
\begin{exercise}{On the covariant approach}%
Let~$A$ be a frame.
\begin{enumerate}
...
intersection and sum of ideals, but that it is in general not a frame.
...
Let~$A$ be a ring. Show that~$\Spec(A)$ is local in the sense of
