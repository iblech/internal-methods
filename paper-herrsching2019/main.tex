...
Section~\ref{sect:appl}, the reduction technique by which we can pretend that a
...
result is a pure syntactical transformation. As it stands, this text could be
...
For readers familiar with the topics of this contribution, we would like to
make a couple of remarks. We present a self-contained proof of the simple
...
infinitary logic, but the basic idea has long been known and summarized, for
instance, in Ref.~\refcite{aczel:russell-prawitz}. % XXX first-order completion. We probably should introduce sites but don't
