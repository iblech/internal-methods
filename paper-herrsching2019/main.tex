...
sheaves in sight. By a \emph{formula over a ring element}~$f \in A$, we mean a
...
\begin{corollary}Let~$A$ be a ring. Let~$\varphi$ be a formula over~$f \in A$.
