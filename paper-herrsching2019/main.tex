...
recommend the leisurely account by Steve Vickers~\ref{XXX} for a fuller
picture.
...
the ef{}fective topos~\cite{XXX}, the Baire space~$\NN^\NN$ is subcountable.
...
spatial~\cite[Example~D4.7.13]{johnstohne:elephant}.\par}
...
\begin{exercise}{Products of locales}\label{ex:products-of-locales}%
...
\begin{exercise}{Coproducts of locales, revisited}%
Let~$X$ and~$X'$ be locales, classifying some propositional geometric
