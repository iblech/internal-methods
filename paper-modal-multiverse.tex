...
\begin{abstract}
  ...
  % than the intriguing endeavour of exploring the range of set-theoretic possibility.
\end{abstract}
...
\begin{proof}
  \begin{enumerate}
    ...
    among all values of~$\alpha$. \vspace*{-0.2em}
    ...
    into a function~$i : \NN \to \NN$; this switches~\textsc{lem} off. \vspace*{-0.2em}
