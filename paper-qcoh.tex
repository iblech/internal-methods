...
Johnstone~\cite{XXX} lists several nongeometric sequents(XXX) holding in the
...
* XXX Discuss related work, results which come close, especially: Olivia 6.1.3, ...
  http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.16.4102 Lemma 4.2
