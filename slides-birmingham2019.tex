...
{\usebackgroundtemplate{\begin{minipage}{\paperwidth}\hspace*{-1.7cm}\includegraphics[height=\paperheight]{black-hole-m87}\end{minipage}}
\begin{frame}[plain]
  \vspace*{\paperheight}\vspace*{-1cm}\scriptsize
  \centering
...
\begin{frame}{The mystery of nongeometric sequents}
  ...
  \begin{center}
    \begin{tikzpicture}[ultra thick, node distance=7mm]
      \node[rectangle, rounded corners=1pt, draw=blue!80, fill=blue!20] (a) {$\ZZ$};
      \node[rectangle, rounded corners=1pt, draw=blue!80, fill=blue!20, right=of a] (b) {$\ZZ[X,Y,Z]/(X^n+Y^n-Z^n)$};
