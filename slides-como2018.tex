...
\begin{frame}{Understanding algebraic geometry}
  ...
  are still missing (for instance pertaining to derived categories and
...
\begin{frame}{Classifying toposes in algebraic geometry}
  ...
  ideal~$\aaa \subseteq B$. Details will be in his \fixedhref{https://gitlab.com/MatthiasHu/master-thesis/raw/master/thesis.pdf}{forthcoming Master's thesis}.
