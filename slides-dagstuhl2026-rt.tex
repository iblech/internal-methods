...
\begin{frame}[plain,c]
  ...
  \begin{minipage}{0.65\textwidth}\begin{block}{}
    \centering\normalsize\color{white}
    \bf
    A 4-slide primer to
    traditional realizability \\[0.3em]
...
\begin{frame}{Number realizability}
  ...
  \begin{tabbing}
    ...
    $e \realizes (\varphi \vee \psi)$ \> iff~$\pi_1 \cdot e \downarrow$ and
    $\pi_2 \cdot e \downarrow$ and \\ \>\qquad if~$\pi_1 \cdot e = 0$
    then~$\pi_2 \cdot e \realizes \varphi$, and \\ \>\qquad if~$\pi_1 \cdot e \neq 0$ then~$\pi_2 \cdot e \realizes \psi$. \\
