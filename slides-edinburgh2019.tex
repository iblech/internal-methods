...
{\usebackgroundtemplate{\begin{minipage}{\paperwidth}\hspace*{-1.7cm}\includegraphics[height=\paperheight]{arthurs-seat-4}\end{minipage}}
\begin{frame}[plain]%
...
\begin{frame}{A different kind of example}
  ...
  Consequence: short and conceptual proof of Grothendieck's generic freeness
  lemma
\end{frame}
