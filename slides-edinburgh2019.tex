...
\begin{frame}[plain]%
  ...
  volcano in Edinburgh. It gives an excellent view of the city and is very much
  recommended for a hiking tour.
  }%
\end{frame}}
\addtocounter{framenumber}{-1}
  ...
  \only<2>{
    ...
    \begin{columns}[t]
      ...
      \begin{column}{0.45\textwidth}
        \includegraphics[width=\textwidth,align=t]{mike-shulman-stack-semantics}
        \vspace*{1.5em}
      \end{column}
    \end{columns}
  }
