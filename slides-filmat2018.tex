  ...
  \begin{changemargin}{-1.1em}{0em}
    ...
    \begin{itemize}
      \item \intex{
        ...
        There is a \hil{Turing machine} which determines of
      ...
      \item \intex{
        ...
        There is a \hil{Turing machine} producing arbitrarily many prime
        numbers.
      }
      ...
      \item \intex{
        ...
        There is a \hil{Turing machine} which, given a Turing
      ...
      \item \intex{
        ...
        Zeros can locally be picked \hil{continuously} in
...
\begin{frame}{Applications in commutative algebra}
  ...
  \hil{For example:}\ \ $\ZZ$,\ \ $\ZZ[X]$,\ \ $\ZZ[X,Y,Z]/(X^n+Y^n-Z^n)$,\ \ $\QQ$,\ \ $\RR$
...
\begin{frame}{Topos theory \ldots}
  \begin{itemize}
    ...
    \item allows to view objects from a different point of view,
