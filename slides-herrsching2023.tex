...
\begin{frame}{A brief timeline}
  ...
  \jnote{5}{
    ...
    of~\textsc{zf} or~\textsc{zfc}, but also class-sized models of~\textsc{zfc}, or models
  ...
  \jnote{6}{
    ...
    explore how the truth value of statements of interest change when we
    travel the multiverse (for instance, by passing from some universe to one
...
\begin{frame}{What can forcing do for you?}
  ...
  \jnote{3}{
    ...
    existence and pass to the complex numbers; the imaginary unit is a
  ...
  \jnote{4}{
    ...
    proofs which use constructively more appropriate inductively defined
    notions. We will discuss an example below.
  }
