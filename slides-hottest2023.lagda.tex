...
\begin{frame}{How should this notion be formalized in HoTT?}
  ...
  \textbf{Def.} $\displaystyle\mathsf{Well}_0(X,{\leq}) \defeq
...
\begin{frame}{Well quasiorders revisited}
  ...
  \textbf{Def.} $\displaystyle\mathsf{Well}(X,{\leq}) \defeq
    \nabla \mathsf{Good} \, \varepsilon$, where
  ...
  \mathsf{Well}_0(X,{\leq})$, but the converse only holds in presence of \hil{bar
