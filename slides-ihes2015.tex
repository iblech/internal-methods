...
\begin{frame}\frametitle{Building a dictionary}
  ...
  \begin{center}
    ...
    \begin{tabular}{ll}
      ...
      locally free sheaf & free module \\
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Gain conceptual clarity.
    \item Develop a synthetic account of scheme theory.
  \end{itemize}
\end{frame}
% Fun facts:
% Take O_X, pullback along X_{negneg} --> X, pushforward: result is K_X.
...
\begin{frame}\frametitle{The gros Zariski topos}
  ...
  \begin{itemize}
    ...
    \item \ldots{} the étale topology is the coarsest topology~$\Diamond$ such
    that
    \[ \forall f : \mathbb{A}^1_X[T]\_
      \text{$f$ is separable} \Rightarrow
