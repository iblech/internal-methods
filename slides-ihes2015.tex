...
\begin{frame}\frametitle{The gros Zariski topos}
  ...
  \begin{itemize}
    ...
    \[ \text{the set of maps $\Delta \to T$,} \]
    where~$\Delta = \{ \varepsilon \in \mathbb{A}^1_X \,|\, \varepsilon^2 = 0
    \}$.
