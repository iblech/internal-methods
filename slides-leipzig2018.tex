...
\begin{frame}{The internal universe of a topos}
  ...
  \fixedhref{http://www.ams.org/journals/bull/2017-54-03/S0273-0979-2016-01556-4/}{notes}).}
...
\begin{frame}{Applications}
  ...
  The next slide shows two examples.}
  ...
  \jnote{2}{\begin{itemize}\justifying
    ...
    implication sign, on toplevel, no long chains of quantifiers of mixed
    ...
    judiciously juggling with open subsets.

    Using the internal language of toposes here is therefore mostly for mental
    hygiene, making rigorous the intuitive idea that the two statements are
    ...
    above. This statement has nontrivial syntactical complexity (the
  ...
  \jnote{3}{We're used to the fact that the usual laws of mathematical
  ...
  nontrivial, different ways}. I find this quite astonishing.
...
\begin{frame}{Synthetic algebraic geometry}
  ...
  unresolved problem in topos theory, the \emph{mystery of nongeometric
  sequents}.
