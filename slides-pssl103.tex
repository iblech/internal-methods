...
\begin{frame}{Curious universes}
  ...
  \hfill \scriptsize
  (see
  \textcolor{red}{\href{https://rawgit.com/iblech/internal-methods/master/images/zeros-in-families.mp4}{video}}
  for counterexample)
\end{frame}
...
\begin{frame}{Nongeometric sequents}
  ...
  \begin{itemize}
    ...
    false. [Bezem--Buchholtz--Coquand 2017; answering a question by Wraith
    possibly raised at PSSL 1.] \\[-1em]
