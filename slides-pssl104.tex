...
\begin{frame}{Flabby sets}
  ...
  is nontrivial. We'll later see that the condition is also interesting for
  ...
  \jnote{5-}{A module is \emph{flabby} if and only if its underlying set is.
...
\begin{frame}{Singular cohomology}
  ...
  and the fibers of~$f$ are in some sense easy to understand. In particular, we
  ...
  framework of singular cohomology is too rigid. For a positive answer we have
...
\begin{frame}{Sheaf cohomology}
  ...
  \jnote{1-}{An injective resolution is a sequence of sheaves and modules and
...
\begin{frame}{Constructive mathematics}
  ...
  instance, there is a technique which allows us to pretend that reduced rings
  are Noetherian and in fact fields -- if in return we switch from classical
  ...
  \fixedhref{http://www.ams.org/journals/bull/2017-54-03/S0273-0979-2016-01556-4/S0273-0979-2016-01556-4.pdf}{written
...
\begin{frame}{Internalizing higher direct images}
  ...
  \begin{itemize}
    ...
    \href{http://www.ams.org/journals/tran/1979-255-00/S0002-9947-1979-0542870-6/S0002-9947-1979-0542870-6.pdf}{[Blass 1979]}.
  ...
  needs, at some point in her life, compute the cohomology of projective space.
