...
\begin{frame}\frametitle{What is the internal language?}
...
\note{\begin{itemize}\justifying
  \item The translation of internal statements into external ones is
  facilitated by an easy mechanical procedure which one quickly grows
  accustomed to. \hyperlink{kripke-joyal}{\beamergotobutton{See more details.}}
...
\section{Building and using a dictionary}
...
%  \end{itemize}
  ...
  Further examples:
  \begin{itemize}
    \item Characterizing quasicoherence internally
    \item Understanding spreading of properties in a logical way
    \item Constructing the relative spectrum internally
  \end{itemize}
\end{frame}
