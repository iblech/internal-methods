...
\begin{frame}{Applications in commutative algebra}
  ...
  \begin{columns}[t]
    \begin{column}[t]{0.46\textwidth}
      ...
      \justifying
      \textbf{Proof.} $M$ is also surjective as a matrix over~$A^\sim$.
      Since~$A^\sim$ is a field, trivially~$1 = 0$ in~$A^\sim$.
      This translates to~$1 = 0$ in~$A$.
    \end{column}
...
\begin{frame}{Internalizing the base}
  \vspace*{-1em}
  ...
  \scalebox{0.83}{\begin{tabular}{ll}
    ...
    tensoring sheaves & tensoring modules \\
