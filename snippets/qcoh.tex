...
\begin{thm}Let~$E \in \Zar(S)$ be an~$\affl$-algebra.
...
quasicompact and quasiseparated, and~$S$ is quasiseparated. We may therefore
...
inherit quasicompactness and quasiseparatedness from~$S$. Therefore we can
apply a comparison result on the categories of quasicoherent
